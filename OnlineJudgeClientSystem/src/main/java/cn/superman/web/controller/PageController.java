...
public abstract class PageController<T, E, V> {
    ...
    @ResponseBody
    public PageResult<V> list(@RequestParam("pageShowCount") int pageShowCount,
                              @RequestParam("wantPageNumber") int wantPageNumber) {
    ...
    @ResponseBody
    public PageResult<V> listWithCondition(@RequestParam("pageShowCount") int pageShowCount,
                                           @RequestParam("wantPageNumber") int wantPageNumber, E condition) {
