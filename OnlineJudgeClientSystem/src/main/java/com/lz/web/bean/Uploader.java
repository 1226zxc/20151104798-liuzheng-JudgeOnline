...
public class Uploader {
    ...
    public void upload() throws Exception {
        ...
        try {
            ...
            sfu.setHeaderEncoding(ConstantParameter.DEFAULT_CHARSET_CODE);
            ...
            while (fii.hasNext()) {
                ...
                if (!fis.isFormField()) {
                    ...
                    this.title = new String(result.toString().getBytes(), ConstantParameter.DEFAULT_CHARSET_CODE);
                    reader.close();
