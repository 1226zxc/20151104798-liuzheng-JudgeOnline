...
appCtrls.controller('problemDetailCtr', function($scope, $http, $timeout, sessionDataBase) {
...
appCtrls.controller('userCtr',function($rootScope, $scope, $http, $pageService, sessionDataBase) {
...
appCtrls.controller('indexCtr', function($rootScope, $scope, $http,
	...
	$scope.registerSubmit = function() {
		...
		$http({
			...
			// success = true注册成功，flase后，message为报错信息
			if (data.success) {
				alert("注册成功");
...
appCtrls.controller('problemCtr', function($rootScope, $scope, $http, sessionDataBase) {
					...
					$scope.jumpDetail = function(index) {
						...
						sessionDataBase.setObject("problemDetailObj", problemDetailObj);
						return true;
					}
				});
